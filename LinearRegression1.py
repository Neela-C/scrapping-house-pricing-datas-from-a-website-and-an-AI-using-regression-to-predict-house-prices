...
# inja mikhastam data haye part ro hazf konam, chon yekam az aval gij bazi daravorde boodam,
# baraye in ke hame chizo avaz nakonam ye temp dorost kardam <@_@> :D
...
'''
   ###this bit is for training data, trained data is already in the folder...
   ###so there is no need to uncomment this, but if u wanted to train the data using database,
   ###you absolutly can :D
