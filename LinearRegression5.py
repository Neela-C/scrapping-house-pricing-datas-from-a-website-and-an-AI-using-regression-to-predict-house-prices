...
## temp = temp[temp['metraj'] < 160] ----> hiich ideyi nadaram vaghti ino neveshtam 
## mikhastam bahash chikar konam va chera neveshtam!
## be in khater commentesh kardam... be nazar mohem nemiad :D
